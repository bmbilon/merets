-- ============================================================================
-- Merets v1.5.02 - Complete Migration Script (FIXED)
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS commitment_submissions (
  ...
  -- Status
  submission_status TEXT NOT NULL DEFAULT 'pending_approval' CHECK (submission_status IN ('pending_approval', 'approved', 'rejected')),
