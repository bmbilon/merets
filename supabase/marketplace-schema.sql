-- Enhanced schema for marketplace-style task management
-- Run this in Supabase SQL Editor

-- 1. Add due date and marketplace fields to task_templates
...
-- 2. Add marketplace fields to commitments
...
-- 3. Create task assignments table for better tracking
...
-- 4. Create task availability view for kids
...
-- 5. Function to get filtered and sorted tasks for marketplace
...
-- 6. Function to claim a task (create commitment)
...
-- 8. Update existing task_templates with some sample due dates (optional)
UPDATE task_templates 
SET 
  due_date = CURRENT_DATE + INTERVAL '3 days',
  urgency_multiplier = 1.2
WHERE title LIKE '%trash%' OR title LIKE '%urgent%';

UPDATE task_templates 
SET 
  due_date = CURRENT_DATE + INTERVAL '1 week',
  max_assignments = 1
WHERE effort_minutes > 30;
