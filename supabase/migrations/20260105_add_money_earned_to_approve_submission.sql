-- FINAL HARDENED approve_submission
-- GPT's 5 fixes + 4 additional hardening improvements
-- A) FOR UPDATE lock
...
-- 1-5. GPT's original fixes (validation, idempotent, updated_at, etc)
