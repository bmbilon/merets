-- Fix claim_marketplace_task to use 'pending_approval' instead of 'pending'
...
GRANT EXECUTE ON FUNCTION claim_marketplace_task(UUID, UUID, TEXT) TO authenticated, anon;
