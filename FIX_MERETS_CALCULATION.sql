-- Update approve_submission to calculate merets based on quality rating and task effort
...
BEGIN
  ...
  -- Calculate merets: base_merets × quality_multiplier
  v_total_merets := ROUND(v_base_merets * v_quality_multiplier, 2);
