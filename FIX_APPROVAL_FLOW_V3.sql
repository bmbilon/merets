-- ============================================================================
-- FIX: Parent Approval Flow - Match TypeScript parameter names
-- Run this in Supabase SQL Editor
-- ============================================================================

-- Drop existing functions first
DROP FUNCTION IF EXISTS approve_submission(uuid,uuid,integer,integer,text);
DROP FUNCTION IF EXISTS reject_submission(uuid,uuid,text);

-- Recreate approve_submission with EXACT parameter names from TypeScript
...
-- Recreate reject_submission with correct parameter names
...
-- ============================================================================
-- DONE! Parameter names now match TypeScript exactly
-- ============================================================================
