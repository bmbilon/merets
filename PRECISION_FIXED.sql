...
DECLARE
    ...
    v_task_base_merets NUMERIC;  -- Changed from DECIMAL(10,2)
    v_kid_balance NUMERIC;        -- Changed from DECIMAL(10,2)
    v_parent_balance NUMERIC;     -- Changed from DECIMAL(10,2)
    v_total_payment NUMERIC;      -- Changed from DECIMAL(10,2)
    v_xp_earned INTEGER;
BEGIN
    -- Get submission data
    ...
    -- Calculate payment
    v_total_payment := COALESCE(v_task_base_merets, 0) + (p_bonus_tip_cents::NUMERIC / 100.0);
