-- ============================================================================
-- FIX: Parent Approval Flow - Accept 'pending_approval' status
...
-- Recreate approve_submission accepting 'pending_approval' status
...
BEGIN
    ...
    -- Accept both 'submitted' and 'pending_approval' statuses
    IF v_submission.submission_status NOT IN ('submitted', 'pending_approval') THEN
        RAISE EXCEPTION 'Submission is not in submitted or pending_approval status (current: %)', v_submission.submission_status;
    END IF;
...
-- Recreate reject_submission accepting 'pending_approval' status
...
BEGIN
    ...
    -- Accept both 'submitted' and 'pending_approval' statuses
    IF v_submission.submission_status NOT IN ('submitted', 'pending_approval') THEN
        RAISE EXCEPTION 'Submission is not in submitted or pending_approval status';
    END IF;
...
-- ============================================================================
-- DONE! Now accepts 'pending_approval' status
-- ============================================================================
