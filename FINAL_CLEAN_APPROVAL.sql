-- ============================================================================
-- FINAL APPROVAL FUNCTION - Clean version without debug logging
-- ============================================================================
...
BEGIN
    ...
    IF v_submission_status NOT IN ('pending_approval', 'submitted') THEN
        RETURN json_build_object('success', false, 'error', 'Submission is not in submitted status');
    END IF;
    ...
    IF v_parent_balance < v_total_payment THEN
        RETURN json_build_object('success', false, 'error', 'Insufficient parent balance');
    END IF;
