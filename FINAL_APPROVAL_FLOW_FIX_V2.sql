...
BEGIN
    ...
    -- Get task details using task_template_id
    SELECT * INTO v_task
    FROM task_templates
    ...
    -- Calculate total payment (base_merets + bonus in cents converted to dollars)
