-- FINAL CLEAN approve_submission function
-- Matches ACTUAL database schema (recipient_id, notification_type, task_approved)
-- Separated rep calculation to trigger
...
BEGIN
  ...
  -- Create notification (using ACTUAL schema: recipient_id, notification_type, task_approved)
  INSERT INTO notifications (
    ...
    'task_approved',
    'Task Approved! 🎉',
    format('Your task was approved with %s stars! You earned %s Merets and $%s', 
           p_quality_rating, 
...
-- ============================================================================
-- DONE - This matches your ACTUAL database schema
-- ============================================================================
