-- ============================================================================
-- ADD EXPH (EXPERIENCE HOURS) FIELD
-- ============================================================================
-- EXPH is a simple total of hours worked from completed tasks
-- This is separate from merets/rep and represents raw time logged
-- ============================================================================
...
SELECT 
  ...
  ROUND(experience_hours, 2) as exph_rounded
FROM user_profiles
